...
$categoryMapping = [
    'work' => 1, // ประเมินพฤติกรรมการปฏิบัติงาน
    'personality' => 2 // ประเมินพฤติกรรมของบุคคล
];
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        if (isset($categoryMapping[$category])) {
            $categoryId = $categoryMapping[$category]; // ใช้ค่าที่เป็นตัวเลข
        } else {
        ...
        $sql = "INSERT INTO form_appraisal (topic_id, evaluator_id, evaluatee_id) 
                VALUES (:category, :evaluator_id, :employee)";
        ...
        // เปลี่ยนหน้าไปยัง officer-forms.php
